...
def bootstrap(name='MicroService', *args, **kwargs):
    list_openapi = Util.load_oai(os.getenv("OPENAPI_MULTIPLE_FILES",
                                           "https://raw.githubusercontent.com/Sciebo-RDS/Sciebo-RDS/master/RDS/circle2_use_cases/port_owncloud.yml;" +
                                           "https://raw.githubusercontent.com/Sciebo-RDS/Sciebo-RDS/master/RDS/circle3_central_services/port_owncloud.yml"))
...
if __name__ == "__main__":
    ...
    register_service(
        "Owncloud",
        os.getenv("OWNCLOUD_OAUTH_AUTHORIZE_URL"),
        os.getenv("OWNCLOUD_OAUTH_ACCESS_TOKEN_URL"),

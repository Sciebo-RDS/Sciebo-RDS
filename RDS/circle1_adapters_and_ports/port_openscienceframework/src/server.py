...
service = OAuth2Service(
    ...
    description={"en": "OSF is a free, open platform to support your research and enable collaboration.",
                 "de": "OSF ist eine kostenlose, offene Plattform, die Ihre Forschung unterstützt und Zusammenarbeit ermöglicht."},

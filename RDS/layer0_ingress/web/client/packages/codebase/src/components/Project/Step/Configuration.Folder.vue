        ...
        <v-list two line>
            <v-list-item>
                <v-list-item-avatar size="3em" class="align-self-start" >
                    <v-icon size="2em" color="black" class="grey lighten-2 rounded-circle pa-16  mx-auto my-8">
                        mdi-numeric-1
                    </v-icon>
                </v-list-item-avatar>

                <v-list-item-content>
                    <v-list-item-title class="text-h6 self-align-start text-wrap" style="line-height: 2em;">
                    ...
                    <v-list-item-subtitle v-if="!currentFilePath" class="py-1 text-wrap">
                        ...
                        color="warning"
                        class="mr-1"
                        @click="togglePicker"> Pick </v-btn> a folder to add metadata to and publish. This folder will be loaded from your sciebo account.
                    ...
                    <v-row v-if="currentFilePath" align="center" class="mt-2">
                        <v-col md="auto" class="grey--text text--darken-3 text-caption text-decoration-underline">
                            Currently selected:
                        </v-col>

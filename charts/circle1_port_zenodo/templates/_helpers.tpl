...
*/}}
{{- define "circle1_port_zenodo.name" -}}
...
*/}}
{{- define "circle1_port_zenodo.fullname" -}}
...
*/}}
{{- define "circle1_port_zenodo.chart" -}}
...
Common labels
*/}}
{{- define "circle1_port_zenodo.labels" -}}
app.kubernetes.io/name: {{ include "circle1_port_zenodo.name" . }}
helm.sh/chart: {{ include "circle1_port_zenodo.chart" . }}

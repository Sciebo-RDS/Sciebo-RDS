...
<div id="wrapper-auto-upload">
    <label>
        ...
        <a href="#" id="helper-auto-upload" title="<?php p($l->t('The system will upload all files in the given folder after some time.')); ?>"><img src="<?php print_unescaped(image_path('', 'actions/info.svg')); ?>" /></a>
    </label>
</div>
<div id="wrapper-apply-changes">
    <label>
        ...
        <a href="#" id="helper-apply-changes" title="<?php p($l->t('Otherwise deletions or file changes are not synchronized to the given services.')); ?>"><img src="<?php print_unescaped(image_path('', 'actions/info.svg')); ?>" /></a>
    </label>
</div>
